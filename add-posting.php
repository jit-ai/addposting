            ...
            <?php if (empty($success)): ?>
                <form method="POST" action="add-posting.php<?php echo $isEditing ? '?id=' . $postId : ($isPatching ? '?patch_id=' . $patchSource : ''); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-section">
                        ...
                        <div class="image-preview-grid" id="existingImagePreview">
                            <?php
                            $imageList = explode(',', $existingImages);
                            foreach ($imageList as $img):
                                $img = trim($img);
                                if (!empty($img)):
                            ?>
                            <div class="image-preview-item">
                                <img src="uploads/postings/<?php echo htmlspecialchars($img); ?>" alt="Existing image">
                            </div>
                            <?php
                                endif;
                            endforeach;
